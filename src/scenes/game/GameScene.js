...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // ボス＆弾幕パターンの初期化
        const bossData = bossList ? bossList[0] : null;
        if (bossData) {
            this.boss = new BossBase(this, 0x8800ff);
            if (bossData.patterns) {
                this.boss.setPattern(bossData.patterns);
            }
        }
